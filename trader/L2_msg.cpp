...
int L2_msg_checkIfData(uint8_t* msg) {
  return (msg[L2_MSG_OFFSET_TYPE] == L2_MSG_TYPE_DATA ||
          msg[L2_MSG_OFFSET_TYPE] == L2_MSG_TYPE_DATA_CONT);
}
...
uint8_t L2_msg_getSeq(uint8_t* msg) { return msg[L2_MSG_OFFSET_SEQ]; }

uint8_t* L2_msg_getWord(uint8_t* msg) { return &msg[L2_MSG_OFFSET_DATA]; }