...
#define CLOCK_SOURCE \
  USE_PLL_HSE_EXTC | USE_PLL_HSI  // set by target:NUCLEO_F446RE
...
#define MBED_CONF_PLATFORM_FORCE_NON_COPYABLE_ERROR \
  0                                                   // set by library:platform
...
#define MBED_CONF_TARGET_LPUART_CLOCK_SOURCE \
  USE_LPUART_CLK_LSE | USE_LPUART_CLK_PCLK1  // set by target:FAMILY_STM32
